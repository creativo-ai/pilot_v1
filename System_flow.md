...
flowchart TD
    ...
    subgraph DATA_LAYER [Data Layer]
        subgraph FIRESTORE [Firestore Collections]
            ...
            AGENT_THREADS_DB[(agent_threads\n thread name *Copy projects stored as named threads copy_project__title*\n instructions, description\n file_refs, thread history per agent ,collected_fields, summary, brand_id )]
    ...
    CAPTION_FLOW <-->|thread history + copy projects| AGENT_THREADS_DB
